...
router.post('/purchase-create', function (req, res) {
  ...
  if (amount < 1) {
    return res.render('alert', {
      ...
      data: {
        message: 'Помилка',
        info: 'Невірна інформація про суму',
...
router.post('/purchase-submit', function (req, res) {
  ...
  if (!firstname || !lastname || !email || !phone) {
    return res.render('alert', {
      ...
      style: 'alert',
      data: {
        message: 'Будь ласка, заповніть обов"язкове поле',
        info: 'Невірні дані',
        link: '/purchase-list',
      },
    })
